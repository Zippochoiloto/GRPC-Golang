...
func (*Contact) Descriptor() ([]byte, []int) {
	return fileDescriptor_contact_c6d1c01f25bdbc21, []int{0}
}
...
func (*InsertRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_contact_c6d1c01f25bdbc21, []int{1}
}
...
func (*InsertResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_contact_c6d1c01f25bdbc21, []int{2}
}
...
func (c *contactServiceClient) Insert(ctx context.Context, in *InsertRequest, opts ...grpc.CallOption) (*InsertResponse, error) {
	...
	err := grpc.Invoke(ctx, "/contact.ContactService/Insert", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("contactpb/contact.proto", fileDescriptor_contact_c6d1c01f25bdbc21) }

var fileDescriptor_contact_c6d1c01f25bdbc21 = []byte{
